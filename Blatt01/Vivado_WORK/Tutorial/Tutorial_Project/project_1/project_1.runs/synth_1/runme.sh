...
HD_PWD='/afs/tu-berlin.de/home/v/vincenthp2603/irb-ubuntu/HardwarePratikum/Blatt01/Vivado_WORK/Tutorial/Tutorial_Project/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ArmDataReplication.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ArmDataReplication.tcl
