...
HD_PWD='/afs/tu-berlin.de/home/v/vincenthp2603/irb-ubuntu/HardwarePratikum/HardwarePRK-SoSe20/Blatt01/Vivado_WORK/Tutorial/Tutorial_Project/HWP1/HWP1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ArmInstructionAddressRegister.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ArmInstructionAddressRegister.tcl -notrace
